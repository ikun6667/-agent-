...
from models.schemas import (POISearchRequest,
    POISearchResponse,
    RouteRequest,
    RouteResponse,
    WeatherResponse)
from services.amap_services import get_amap_service
router=APIRouter(prefix='/map',tags=['地图服务'])
@router.get('/poi',response_model=POISearchResponse,summary='搜索POI',description='根据关键词搜索POI（兴趣点)')
async def search_poi(
        keywords:str=Query(...,description="搜素关键词",example='故宫'),
